...
# Мета: Знайти λ ∈ 𝔽_q таке, що φ(P)=(ωx, y)=[λ]P

# Це λ буде власним значенням ендоморфізму φ, яке узгоджено з ω, знайденим у A1.

# Метод
# - Оскільки φ³ = id, то λ повинно задовольняти:        λ² + λ + 1 ≡ 0 mod q
# - Розв'язки цього рівняння:                           λ = (–1 ± √–3)/2 mod q
# - Після перевірки обидвох λ, залишили те, для якого:  φ(G) = [λ]G для G = (1, 2)
