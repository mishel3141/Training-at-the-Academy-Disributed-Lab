...
## Мета: реалізувати обчислення [α₁]P₁+[α₂]P₂ # у контексті GLV-множення, де:
#    - P₁ = P
#    - P₂ = φ(P)
#     - α₁, α₂ — отримані з GLV-декомпозиції (A3)

## Метод: Алгоритм 3.48 з книги [1] (Hankerson, Menezes, Vanstone), також відомий як метод Шаміра (Shamir’s Trick).

## Основна ідея:  Побудувати таблицю додавання для 4 можливих комбінацій бітів:
#     (0,0) → 𝒪  
#     (0,1) → P₂  
#     (1,0) → P₁  
#     (1,1) → P₁ + P₂
